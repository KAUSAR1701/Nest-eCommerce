...
function Banner() {
  const settings = {
    ...
    customPaging: (i) => (
      <div className="w-4 h-4 rounded-full border-2 border-balck cursor-pointer">
        {i + 1}
      </div>
    ),
  };
      ...
      <div className="container px-0 banner_slider">
        <Slider {...settings}>
          <div>
            ...
            >
              <h1 className="font-bold text-3xl md:text-3xl lg:text-7xl text-primary max-w-2xl">
                Fresh Vegetables Big discount
              </h1>
              <p className="pt-5 md:pt-10 pb-5 md:pb-16 text-lg lg:text-3xl font-normal text-secondary">
              ...
              <div className=" bg-white rounded-full max-w-md flex items-center gap-2 pl-2">
                ...
                />
                <button className="px-3 md:px-10 py-2 md:py-5 bg-brand rounded-full text-white text-base cursor-pointer">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            >
              <h1 className="font-bold text-3xl md:text-3xl lg:text-7xl text-primary max-w-4xl">
